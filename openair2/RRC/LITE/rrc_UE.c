...
static void rrc_ue_generate_MeasurementReport(protocol_ctxt_t* const ctxt_pP, uint8_t eNB_index )
{
  ...
  printf("magicwo_eNB_index:%d",eNB_index);
  printf("magicwo_module_id:%d",ctxt_pP->module_id);
  ...
  LOG_I(RRC,"[Magicwo UEtag5]\n");
      if (pframe!=ctxt_pP->frame) {
  LOG_I(RRC,"[Magicwo UEtag6]\n");
...
printf("magicwo:get_n_adj_cells:%d",1+mac_xface->get_n_adj_cells(ue_mod_idP,0));
...
printf("magicwo:NB_eNB_INST:%d ",NB_eNB_INST);
