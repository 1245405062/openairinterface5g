        ...
        S1ap_SuccessfulOutcome_t *successfullOutcome_p)
{
    ...
    case S1ap_ProcedureCode_id_PathSwitchRequest:
        ret = s1ap_decode_s1ap_pathswitchrequestacknowledgeies(
                  &message->msg.s1ap_PathSwitchRequestAcknowledgeIEs, &successfullOutcome_p->value);
        s1ap_xer_print_s1ap_pathswitchrequestacknowledge(s1ap_xer__print2sp, message_string, message);
        printf("enb_received_path_switch_request\n");
        fflush(stdout);
        break;
    default:
